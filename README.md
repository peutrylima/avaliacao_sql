...
* **Manipulação de Dados (DML) e Integridade Relacional**:
    * Uso de **Subqueries** para deletar registros condicionados a dados de outras tabelas (`DELETE` com `IN`).
